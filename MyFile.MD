...
Get-Help Update-M365DSCAzureAdApplication -Examples
...
Update-M365DSCAzureAdApplication `
    ...
    -MonthsValid 12 `
    -Credential $creds `
    -CertificatePath C:\Temp\M365DSC.cer
...
New-MgApplication -DisplayName "TestApp"


Get-MgContext | Select Account,Scopes
